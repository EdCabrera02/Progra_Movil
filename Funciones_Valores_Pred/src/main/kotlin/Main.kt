fun main(){
    imprimir("Reemplazo del 1er valor","Reemplazo el 2do valor")
...
fun imprimir(valor1: String = "Este es el 1er valor por defecto",
             valor2: String = "Este es el 2do valor por defecto"){
    println(valor1)
    println(valor2)
}
